...
exports.inWitchRing = exports.generateListObject = exports.changeTmpAngle = exports.getTextPercent = exports.getTextAlignPercent = exports.getRotate = exports.getPointPosition = exports.startRadius = undefined;
...
var inWitchRing = exports.inWitchRing = function inWitchRing(_ref4) {
  var radiusList = _ref4.radiusList,
      endRadiusList = _ref4.endRadiusList,
      eventPosition = _ref4.eventPosition,
      center = _ref4.center,
      lineWidth = _ref4.lineWidth;

  if (!eventPosition) return null;
  var x = eventPosition.x - center.x;
  var y = eventPosition.y - center.y;
  var pRadius = Math.sqrt(x * x + y * y); // point radius
  var halfLineWidth = lineWidth / 2;
  for (var i = 0; i < radiusList.length; i += 1) {
    var beginRadius = radiusList[i] - halfLineWidth;
...
var checkPointInRing = function checkPointInRing(_ref5) {
  var x = _ref5.x,
      y = _ref5.y,
      endRadius = _ref5.endRadius;

  var xyangle = Math.atan(y / x) * (180 / Math.PI);
  console.log('getRealAngleByQuadrant(xyangle, x, y)', getRealAngleByQuadrant({ xyangle: xyangle, x: x, y: y }));
  return endRadius > getEndRadius(getRealAngleByQuadrant({ xyangle: xyangle, x: x, y: y }) / 360);
};

var getRealAngleByQuadrant = function getRealAngleByQuadrant(_ref6) {
  var xyangle = _ref6.xyangle,
      x = _ref6.x,
      y = _ref6.y;

...
var RadialBarChart = function (_React$Component) {
  ...
  function RadialBarChart() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RadialBarChart.__proto__ || Object.getPrototypeOf(RadialBarChart)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var ringInfo = _this.ring.updateRing({ event: 'onClick', eventPosition: (0, _reactChartAdapt.getEventPosition)(e) }, _this.ctx);
      ...
      if (_this.ring) _this.ring.updateRing(Object.assign(_extends({}, _this.props), { width: ratioWidth, height: ratioHeight, ratio: ratio }), _this.ctx);

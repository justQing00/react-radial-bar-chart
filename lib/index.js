...
var RadialBarChart = function (_React$Component) {
  ...
  function RadialBarChart() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RadialBarChart.__proto__ || Object.getPrototypeOf(RadialBarChart)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.canvas.width = $parentNode.clientWidth;
      _this.canvas.height = $parentNode.clientHeight;
      _this.ring.updateRing({ width: $parentNode.clientWidth, height: $parentNode.clientHeight }, _this.ctx);
  ...
  _createClass(RadialBarChart, [{
    ...
    value: function componentDidMount() {
      ...
      this.ring = new _ring2.default({
        list: [{ name: '问题1', percent: 0.85 }, { name: '问题2', percent: 0.5 }, { name: '问题3', percent: 0.5 }, { name: '问题4', percent: 0.4 }, { name: '问题5', percent: 0.3 }, { name: '问题6', percent: 0.2 }]
      });
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(_tooltip2.default, _extends({ tooltip: tooltip, ringInfo: ringInfo }, eventPosition)),
        React.createElement('canvas', { style: { position: 'absolute' }, ref: function ref(canvas) {

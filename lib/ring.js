...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setValue = function () {
    ...
    _this.fillStyle = props.fillStyle || _this.fillStyle || 'rgba(0, 0, 0, 0.65)';
    ...
    // generate
    var maxHalf = parseInt(Math.min(_this.width, _this.height) / 2, 10);
    ...
    var maxRadius = maxHalf - _this.lineWidth / 2;

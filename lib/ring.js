  ...
  this.drawBase = function (ctx) {
    ...
    for (var i = 0; i < length; i += 1) {
      ...
      if (_this.currentRing === i) {
        ...
        gradient.addColorStop('0', (0, _color.getHoverRgbColor)(_this.strokeStyleList[i], 1));
        gradient.addColorStop('1', (0, _color.getHoverRgbColor)(_this.strokeStyleList[i], 0.56));

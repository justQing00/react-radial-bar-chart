...
var _colorConversion = require('color-conversion');
  ...
  this.drawBase = function (ctx) {
    ...
    for (var i = 0; i < length; i += 1) {
      ...
      if (_this.currentRing === i) {
        ctx.strokeStyle = (0, _colorConversion.getHoverRgbColor)(_this.strokeStyleList[i]);
        ...
        gradient.addColorStop('0', (0, _colorConversion.getHoverRgbColor)(_this.strokeStyleList[i], 1));
        gradient.addColorStop('1', (0, _colorConversion.getHoverRgbColor)(_this.strokeStyleList[i], 0.56));
